"""Step 07: Model groups as «Union» classes + group member relations.

Top-level <group> declarations (e.g. CityModelMemberGroup) encode union
types in the CityGML conceptual model. They are added to the diagram as
«Union» class boxes (the "Group" suffix is removed from the name).
The relations their members produce (cityObjectMember, appearanceMember)
are extracted by step 05's group expansion.

Usage:
    python3 step07_groups.py [xsd_path] [output_path]
"""
